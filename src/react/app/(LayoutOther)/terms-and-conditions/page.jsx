  ...
  return (
    <div>
      ...
      <div className="container my-12 text-base text-justify space-y-4">
        <h2 className="text-3xl font-bold text-left">Terms and Conditions</h2>

        <h3 className="text-xl font-medium text-left">Welcome to TechWizard!</h3>

        <p>
          These terms and conditions outline the rules and regulations for the use of its Website,
          located at{' '}
        ...
        <p>
          ...
          continue to use TechWizard if you do not agree to take all of the terms and conditions
          stated on this page.
        </p>
        ...
        <p>
          ...
          subject to, prevailing law of bd. Any use of the above terminology or other words in the
        ...
        <p>
          We employ the use of cookies. By accessing here, you agreed to use cookies in agreement
          with the TechWizard.'s Privacy Policy.
        </p>
        ...
        <p>
          Unless otherwise stated, TechWizard. and/or its licensors own the intellectual property
          rights for all material on TechWizard. All intellectual property rights are reserved. You
          may access this from here for your own personal use subjected to restrictions set in these
          terms and conditions.
        </p>

        <p>You must not:</p>
        <ul className="list-disc list-inside pl-4">
          <li>Republish material from TechWizard.</li>
        ...
        <p>
          Parts of this website offers an opportunity for users to post and exchange opinions and
          information in certain areas of the website. TechWizard does not filter, edit, publish or
          review Comments prior to their presence on the website. Comments do not reflect the views
          and opinions of its agents and/or affiliates. Comments reflect the views and opinions of
          the person who post their views and opinions. To the extent permitted by applicable laws,
          TechWizard shall not be liable for the Comments or for any liability, damages or expenses
          caused and/or suffered as a result of any use of and/or posting of and/or appearance of
          the Comments on this website.
        </p>

        <p>
          TechWizard. reserves the right to monitor all Comments and to remove any Comments which
        ...
        <p>
          You hereby grant TechWizard. a non-exclusive license to use, reproduce, edit and authorize
        ...
        <p>
          ...
          visibility of the hyperlink compensates the absence of TechWizard and (d) the link is in
        ...
        <p>
          ...
          linking to our website, you must inform us by sending an e-mail to TechWizard.. Please
        ...
        <p>
          No use of TechWizard.'s logo or other artwork will be allowed for linking absent a

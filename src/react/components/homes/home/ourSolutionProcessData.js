  ...
  topics: [
    {
      ...
      description:
        "The first critical step in our solution process for AlpineProHealth is to identify a problem. This starts with a deep needs assessment so as to understand the challenges in the organization.",
    },
    {
      topicName: 'Define Objectives and Goals',
      description:
        'With an identified problem, we set certain measurable objectives that guide our efforts. These goals are carefully tailored to point toward the overall mission and vision of AlpineProHealth. ',
    },
    {
